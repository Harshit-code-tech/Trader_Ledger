...
def export_audit_csv(matches: list, trades_by_id: dict, trade_ts_map: dict, remainder_flags: dict, profile_name: str | None = None) -> str:
    ...
    with open(filepath, 'w', newline='', encoding='utf-8') as f:
        ...
        writer.writerow([
            ...
            "MatchedMtfAmount", "HoldingDays", "MtfInterest", "MtfRatePpmUsed", "NetPnL",
        ...
        for idx, match in enumerate(matches):
            ...
            writer.writerow([
                ...
                match.get('holding_days', 0), rupees(int(match.get('mtf_interest', 0)), absolute=True), match.get('mtf_rate_ppm', 0),
